...
var marvel1_1 = require("./marvel1");
var literalobject = {
    name: 'fred',
    topic: 'es6'
};
function startup() {
    var m = new marvel1_1.Marvel();
...
function fetchyAsync() {
    return __awaiter(this, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('https://swapi.co/api/people/1')];
                case 1:
                    res = _a.sent();
                    passAsync(res);
                    return [2 /*return*/];
